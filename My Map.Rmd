...
```
The source code is available at [GitHub](https://github.com/pranithacse/Developing-Data-Products/blob/main/Data%20Science%20Specialization. [Just click here!] ( https://github.com/pranithacse/Developing-Data-Products/blob/main/My%20Map.Rmd )
...
map %>%
   addTiles() %>%
   addMarkers(lat=33.8938, lng=35.5018, popup = benrathPalacePopup)
```
